...
public class CivDrawing 
  ...
  protected ImageFigure cityUnitIcon;
  protected TextFigure unitMovesText;
  ...
  protected void defineIcons() {
    ...
    ageText = new TextFigure("4000BC",
            new Point(GfxConstants.AGE_TEXT_X,
                    GfxConstants.AGE_TEXT_Y) );
    unitMovesText = new TextFigure("",
    ...
    cityUnitIcon = new ImageFigure( GfxConstants.NOTHING,
  ...
  public void turnEnds(Player nextPlayer, int age) {
    ...
    turnShieldIcon.set( playername+"shield",
                        new Point( GfxConstants.TURN_SHIELD_X,
                                   GfxConstants.TURN_SHIELD_Y ) );
    while (delegate.findFigure(GfxConstants.AGE_TEXT_X, GfxConstants.AGE_TEXT_Y) != null) {
      delegate.remove(delegate.findFigure(GfxConstants.AGE_TEXT_X, GfxConstants.AGE_TEXT_Y));
    }

    if (age < 0) {
      ageText.setText("" + (-1 * age) + "BC");
    }
    else{
  ...
  public void tileFocusChangedAt(Position position) {
    ...
    if (city != null){
      ...
      workforceFocusIcon.set( city.getWorkforceFocus(),
              new Point( GfxConstants.WORKFORCEFOCUS_X,
                      GfxConstants.WORKFORCEFOCUS_Y ) );
      if (city.getProduction() != "UNSPECIFIED_UNIT") {
        cityUnitIcon.set(city.getProduction(),
                new Point(GfxConstants.CITY_PRODUCTION_X,
                        GfxConstants.CITY_PRODUCTION_Y));
      }
      else {
        cityUnitIcon.set( GfxConstants.NOTHING,
                new Point(GfxConstants.CITY_PRODUCTION_X,
                        GfxConstants.CITY_PRODUCTION_Y));
      }
    }
    ...
    while (delegate.findFigure(GfxConstants.UNIT_COUNT_X, GfxConstants.UNIT_COUNT_Y) != null) {
      delegate.remove(delegate.findFigure(GfxConstants.UNIT_COUNT_X, GfxConstants.UNIT_COUNT_Y));
    }
